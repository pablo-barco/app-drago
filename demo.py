...
def conectar_google():
    ...
    # ✨ CAMBIO CLAVE: Aquí es donde la app busca la hoja de pruebas genérica
...
if st.session_state["usuario_actual"] is None:
    ...
    with tab5:
        ...
        # COMPENSADOR HISTÓRICO DEMO
        ajustes_historicos = {"Justo": 556.94, "Rubén": 200.00}
        ...
        with col_i:
            with st.expander("📥 Aportación al Bote"):
                ...
                # Casilla para especificar el motivo del ingreso
